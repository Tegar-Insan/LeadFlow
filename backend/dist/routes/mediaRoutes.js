...
router.post('/upload/:scheduleId', requireRole(['marketing_staff', 'admin']), controller.uploadMiddleware, controller.uploadMedia);
// Get all media for a schedule
router.get('/:scheduleId', requireRole(['marketing_staff', 'business_owner', 'admin']), controller.getMediaBySchedule);
// Delete a single asset
router.delete('/:assetId', requireRole(['marketing_staff', 'admin']), controller.deleteMedia);
