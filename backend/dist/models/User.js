...
async function findAll({ page = 1, limit = 20, roleId = null } = {}) {
    let q = db
        .from('users')
...
module.exports = { findByEmail, findById, emailExists, create, markEmailVerified, updatePassword, setActive, findAll };
