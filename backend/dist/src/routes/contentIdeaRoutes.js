...
import { generate, generateWithSteps, listPending, clearPending } from "../controllers/contentIdeaController.js";
...
router.delete('/pending', roleMiddleware(['marketing_staff', 'admin']), clearPending);
