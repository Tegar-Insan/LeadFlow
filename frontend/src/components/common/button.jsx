...
export default function Button({
  ...
  const base = 'inline-flex items-center justify-center gap-2 font-display font-semibold rounded-xl transition-all duration-200 focus:outline-none active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed select-none';

  const variants = {
    primary:   'bg-brand hover:bg-brand-dark text-white focus:ring-2 focus:ring-brand/40 shadow-lg shadow-brand/20',
